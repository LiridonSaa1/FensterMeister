            ...
            {filteredClients.map((client) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {client.companyName && (
                            <p className="text-[11px] text-slate-500 font-medium">{client.companyName}</p>
                          )}
                        </div>
                      </div>
                  ...
                  {/* Financial Mini Footer */}
                  <div className="pt-3 flex items-center justify-between text-xs">
                    <div>
                      <span className="text-[10px] text-slate-400 block font-semibold">{t.clients.totalInvoiced}</span>
                      <span className="font-bold text-slate-900 font-mono">{formatCurrency(cRevenue, currency)}</span>
                    </div>
